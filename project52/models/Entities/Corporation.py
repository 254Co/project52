...
class Corporation:
    ...
    def __init__(
        ...
        **data: Any
        ...
        self.data = data
        self.price_history: List[tuple[datetime, float]] = [(datetime.utcnow(), share_price)]
    ...
    def _create_header(self) -> Panel:
        ...
        subtitle = Text(self.BRAND_TAGLINE, style="italic white on gold1", justify="center")
        stock = Text(f"{self.ticker} — {self.name}", style="bold yellow", justify="center")
        header = Align.center(Text.assemble(title, "\n", subtitle, "\n", stock), vertical="middle")
    ...
    def _create_summary_panel(self) -> Panel:
        ...
        return Panel(table, title="[bold]Summary[/bold]", box=box.ROUNDED, border_style="cyan")
    ...
    def _create_metrics_panel(self) -> Panel:
        ...
        return Panel(table, title="[bold]Metrics[/bold]", box=box.ROUNDED, border_style="magenta")
    ...
    def _create_history_panel(self, limit: int = 10) -> Panel:
        ...
        return Panel(table, title="[bold]Recent Prices[/bold]", box=box.ROUNDED, border_style="blue")
...
if __name__ == '__main__':
    ...
    corp = Corporation(
        name="Dynamic Corp", ticker="DYN", industry="Technology",
        exchange="NASDAQ", country="USA", founded=date(2000,1,1),
        shares_outstanding=50_000_000, share_price=120.5,
        headquarters="NYC", employees=5000
    )
