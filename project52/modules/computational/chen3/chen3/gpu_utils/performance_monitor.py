        ...
        with self.device:
            try:
                ...
                gpu_util = cp.cuda.runtime.deviceGetAttribute(
                    cp.cuda.runtime.cudaDevAttrComputeMode,
                    self.device_id
                )
                ...
                compute_util = cp.cuda.runtime.deviceGetAttribute(
                    cp.cuda.runtime.cudaDevAttrComputeCapabilityMajor,
                    self.device_id
                )
                ...
                try:
                    power = cp.cuda.runtime.deviceGetAttribute(
                        cp.cuda.runtime.cudaDevAttrMaxPower,
                        self.device_id
                    )
                except:
                    power = 0.0
                ...
                try:
                    temp = cp.cuda.runtime.deviceGetAttribute(
                        cp.cuda.runtime.cudaDevAttrMaxThreadsPerBlock,
                        self.device_id
                    )
                except:
                    temp = 0.0
