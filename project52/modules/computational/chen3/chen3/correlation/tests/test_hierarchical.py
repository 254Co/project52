...
import numpy as np
import pytest
from ..models.hierarchical import HierarchicalCorrelation, create_hierarchical_correlation
...
def test_string_representations():
    ...
    assert str(corr) == "HierarchicalCorrelation(n_clusters=2, within=0.80, between=0.40, global=0.20)"
